 ...
 *
 */
public class ModularExpression extends AbstractArithmeticExpression {

	public ModularExpression(Operand operand, Operand operand2) {
		super(ArithmeticOperator.MODULAR, operand, operand2);

 ...
 *
 */
public class GreatThanExpression extends AbstractRelationExpression {

	public GreatThanExpression(Operand lOperand, Operand rOperand) {
		super(OperatorType.BINARY, RelationOperator.GT, lOperand, rOperand);

 ...
 *
 */
public class BitwiseAndExpression extends AbstractArithmeticExpression {

	public BitwiseAndExpression(Operand operand, Operand operand2) {
		super(ArithmeticOperator.BITWISEAND, operand, operand2);

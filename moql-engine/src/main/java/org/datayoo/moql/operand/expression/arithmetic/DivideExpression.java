...
public class DivideExpression extends AbstractArithmeticExpression {
  ...
  public DivideExpression(Operand operand, Operand operand2) {
    super(ArithmeticOperator.DIVIDE, operand, operand2);
  ...
  protected Object calc(Number number, Number number2,
    ...
    Number ret = ArithmeticUtils.divide(number, number2);

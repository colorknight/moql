 ...
 *
 */
public class LittleThanExpression extends AbstractRelationExpression {

	public LittleThanExpression(Operand lOperand, Operand rOperand) {
		super(OperatorType.BINARY, RelationOperator.LT, lOperand, rOperand);

...
public abstract class AbstractOperationExpression extends AbstractExpression
  ...
  public AbstractOperationExpression(OperatorType operatorType,
      OperatorGetter operator, Operand lOperand, Operand rOperand) {
  ...
  public void bind(String[] entityNames) {
    if (lOperand != null)
      lOperand.bind(entityNames);
    if (rOperand != null)
      rOperand.bind(entityNames);
    this.binded = true;
  }
}

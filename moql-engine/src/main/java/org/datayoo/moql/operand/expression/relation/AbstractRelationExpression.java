 ...
 *
 */
public abstract class AbstractRelationExpression extends
		AbstractOperationExpression {
	
	public AbstractRelationExpression(OperatorType operatorType, OperatorGetter operator, Operand operand, Operand operand2) {
		super(operatorType, operator, operand, operand2);

 ...
 *
 */
public class LittleAndEqualExpression extends AbstractRelationExpression {

	public LittleAndEqualExpression(Operand lOperand, Operand rOperand) {
		super(OperatorType.BINARY, RelationOperator.LE, lOperand, rOperand);

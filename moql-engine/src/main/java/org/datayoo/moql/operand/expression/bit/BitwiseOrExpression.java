 ...
 * @author Tang Tadin
 */
public class BitwiseOrExpression extends AbstractBitwiseExpression {

  public BitwiseOrExpression(Operand lOperand, Operand rOperand) {
    super(BitwiseOperator.BITWISEOR, lOperand, rOperand);

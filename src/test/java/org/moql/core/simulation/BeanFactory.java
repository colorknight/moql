...
public abstract class BeanFactory {
	...
	public static List<BeanC> createBeanCList(int startNumber,int size) {
	 ...
	 public static List<LittileBean> createLittleBeanList(int startNumber,int size) {
	...
	public static List<ScoreItem> createScoreItems() {
		...
		String[] subjects = new String[] {"Language","Logic","Scientist","Nature"};
		int[] scores = new int[] {83,79,98,85,85,82,74,91,93,95,88,94,69,87,89,97,93,62,73,88};

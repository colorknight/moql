...
import org.moql.core.simulation.BeanB;
import org.moql.core.simulation.BeanC;
import org.moql.core.simulation.BeanE;
import org.moql.core.simulation.BeanFactory;
import org.moql.core.simulation.ScoreItem;
...
public class TestSelector extends TestCase {
  ...
  public void testRowTranspositonDecorator() {
    ...
    try {
      ...
      selector = MoqlUtils.createSelector(sql);
      selector.select(dataSetMap);

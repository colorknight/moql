...
public interface SqlTranslator {
  ...
  String translate2Sql(Selector selector, Map<String, Object> translationContext);

  String translate2Condition(Filter filter);

  String translate2Condition(Filter filter, Map<String, Object> translationContext);

  void addFunctionTranslator(FunctionTranslator functionTranslator);

  void addAllFunctionTranslator(List<FunctionTranslator> functiionTranslators);

  FunctionTranslator removeFunctionTranslator(String functionName);
